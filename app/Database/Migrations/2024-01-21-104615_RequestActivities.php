...
class RequestActivities extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'activity_id' 	=> ['type' => 'INTEGER','constraint' => 11,],
		...
		$this->forge->createTable('request_activities', false, $attributes);
    }

    public function down()
    {
        //
		$this->forge->dropTable('request_activities');
    }
}
